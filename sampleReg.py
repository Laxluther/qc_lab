...
class SampleRegister:
    def __init__(self, flask_app):
        self.app = Dash(__name__, server=flask_app,
                        url_base_pathname='/sample_register/')
        self.setup_layout()
    ...
    def setup_callbacks(self):
        ...
        def func(n_clicks, start_date, end_date):
            ...
            worksheet.title = "Sample Register"
            worksheet.merge_cells('A1:S1')
            worksheet['A1'].value = "Sample Register"
            ...
            third_col_letter = get_column_letter(3)   
            worksheet.column_dimensions[third_col_letter].width = 20   
            workbook.save(output)
            output.seek(0)
            return dcc.send_bytes(output.getvalue(), "Sample_Register.xlsx")
